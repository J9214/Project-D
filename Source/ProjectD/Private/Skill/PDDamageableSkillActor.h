...
#include "SkillActor/PDPlacedSkillActorBase.h"
...
UCLASS()
class PROJECTD_API APDDamageableSkillActor : public APDPlacedSkillActorBase, public IAbilitySystemInterface
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, ReplicatedUsing=OnRep_ShieldVisuals, Category="Shield")
