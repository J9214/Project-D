...
private:
	...
	STEAM_GAMESERVER_CALLBACK(FOnlineAsyncTaskManagerSteam, OnSteamServersConnectedGS, SteamServersConnected_t, SteamServersConnectedGSCallback);
...
public:
	...
	FOnlineAsyncTaskManagerSteam(class FOnlineSubsystemSteam* InOnlineSubsystem) :
		...
		SteamServersConnectedGSCallback(this, &FOnlineAsyncTaskManagerSteam::OnSteamServersConnectedGS),
